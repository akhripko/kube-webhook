...
func TestService_AddOwners_Create(t *testing.T) {
...
func TestService_AddOwners_Create_WithOwners(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
				ownersKey: "userB, userC",
			},
		},
	})
	require.NoError(t, err)
...
func TestService_AddOwners_Update_Owner(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
...
func TestService_AddOwners_Update_NotOwner(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
	...
	expected := admission.AdmissionResponse{
		UID:     req.UID,
		Allowed: true,
		Patch:   []byte(`[{"op":"add","path":"/metadata/annotations/` + ownersKey + `","value":"userB,userC,userA"}]`),
	}
...
func TestService_AddOwners_Update_Owner_WithOwners(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
...
func TestService_AddOwners_Update_Admin(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
...
func TestService_AddOwners_Create_Admin(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
...
func TestService_AddOwners_Create_System(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
...
func TestService_AddOwners_Update_System(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
...
func TestService_AddOwners_Update_System_EmptyOwners(t *testing.T) {
	obj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
...
func TestService_AddOwners_Delete_Allowed(t *testing.T) {
	oldObj, err := json.Marshal(AdmissionRequestObject{
		TypeMeta: meta.TypeMeta{},
		ObjectMeta: meta.ObjectMeta{
			Annotations: annotations{
