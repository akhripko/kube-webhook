...
func TestHTTPSrv_addOwnersHandleFunc(t *testing.T) {
	...
	service.EXPECT().AddOwners(&admissionRequest).DoAndReturn(func(*admission.AdmissionRequest) *admission.AdmissionResponse {
	...
	req, err := http.NewRequest("POST", "/add-owners", bytes.NewReader(admissionReviewJSON))
	require.NoError(t, err)
...
func TestHTTPSrv_addOwnersHandleFunc_empty(t *testing.T) {
	// prepare request data
...
func TestHTTPSrv_addOwnersHandleFunc_wrongJson(t *testing.T) {
	// prepare request data
...
func TestHTTPSrv_addOwnersHandleFunc_emptyRequest(t *testing.T) {
	// prepare request data
	admissionReview := admission.AdmissionReview{}
	admissionReviewJSON, err := json.Marshal(admissionReview)
	require.NoError(t, err)
