...
func TestHTTPSrv_validateHandleFunc(t *testing.T) {
	...
	service.EXPECT().Validate(&admissionRequest).DoAndReturn(func(*admission.AdmissionRequest) *admission.AdmissionResponse {
	...
	req, err := http.NewRequest("POST", "/validate", bytes.NewReader(admissionReviewJSON))
	require.NoError(t, err)
...
func TestHTTPSrv_validateHandleFunc_empty(t *testing.T) {
	// prepare request data
...
func TestHTTPSrv_validateHandleFunc_wrongJson(t *testing.T) {
	// prepare request data
...
func TestHTTPSrv_validateHandleFunc_emptyRequest(t *testing.T) {
	// prepare request data
	admissionReview := admission.AdmissionReview{}
	admissionReviewJSON, err := json.Marshal(admissionReview)
	require.NoError(t, err)
